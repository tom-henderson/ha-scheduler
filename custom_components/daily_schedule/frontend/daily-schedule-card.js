...
`;let Dt=class extends ot{constructor(){super(...arguments),this._name="",this._targets=[],this._save=()=>{this.dispatchEvent(new CustomEvent("bar-settings-save",{detail:{name:this._name.trim()||this.bar.name,targets:this._targets}}))}}willUpdate(t){t.has("bar")&&(this._name=this.bar.name,this._targets=[...this.bar.targets])}render(){const t=yt[this.bar.type]??[],e={entity:{multiple:!0,filter:{domain:t}}};return W`
    ...
    `}_renderSegmentTrack(t){const e=$t(this.bar.type),i=kt(this.types,this.bar.type,this.bar.base),s=(n=this.bar,r=this.now,Tt(n).find(t=>r>=t.start&&r<t.end));var n,r;return W`
    ...
    `}_renderPin(t){const e=t.at/gt*100,i=this._drag?.id===t.id,s=this._triggerLabel(t),n=`${xt(t.at)} · ${s}${t.jitter?` · ${Ot(t.jitter)}`:""}`;return W`
      <div
    ...
    `}_renderSegment(t){const e=kt(this.types,this.bar.type,t.state),i=t.start/gt*100,s=(t.end-t.start)/gt*100,n=e?(r=this.types,a=this.bar.type,o=t,zt(r,a).map(t=>{if("media"===t.kind){const t=o.data?.media_title??o.data?.media_content_id;return t?String(t):""}const e=jt(r,a,o.state,o,t);return null==e||""===e?"":"slider"===t.kind?`${Math.round(100*Number(e))}%`:"number"===t.kind?`${e}${t.unit??""}`:"select"===t.kind?St(String(e)):String(e)}).filter(Boolean).join(" · ")):"";var r,a,o;const d=n||At(this.types,this.bar.type,t.state),c=e?Mt(this.types,this.bar.type,t):"",l=this._drag?.id===t.id,h=l&&("move"===this._drag.mode||"l"===this._drag.mode),p=l&&("move"===this._drag.mode||"r"===this._drag.mode),u=`${xt(t.start)}–${xt(t.end)} · ${d}${t.jitter?` · ${Ot(t.jitter)}`:""}`;return W`
      <div
      ...
      >
        ...
        ${s>8?W`<span class="seg-label"
              >${d}${t.jitter?W`<ha-icon icon="mdi:dice-5" style="--mdc-icon-size:12px"></ha-icon>`:q}</span
            >`:q}
        <div class="handle r" @pointerdown=${e=>this._dragSeg(t,"r",e)}>
          <span></span>
        </div>
        ${h?W`<div class="bubble l">${xt(t.start)}</div>`:q}
        ${p?W`<div class="bubble r">${xt(t.end)}</div>`:q}
      </div>
    `}};Bt.styles=[Rt,a`
    .bar {
      margin-bottom: 14px;
  ...
  `],t([pt({attribute:!1})],Bt.prototype,"hass",void 0),t([pt({attribute:!1})],Bt.prototype,"bar",void 0),t([pt({attribute:!1})],Bt.prototype,"types",void 0),t([pt({type:Boolean})],Bt.prototype,"scheduleOn",void 0),t([pt({attribute:!1})],Bt.prototype,"conflicts",void 0),t([pt({type:Number})],Bt.prototype,"now",void 0),t([pt({type:Boolean})],Bt.prototype,"syncing",void 0),t([ut()],Bt.prototype,"_editing",void 0),t([ut()],Bt.prototype,"_drag",void 0),Bt=t([ct("ds-bar")],Bt);let It=class extends ot{constructor(){super(...arguments),this.accent="",this.entities=[],this._si=0,this._start="",this._end="",this._jit=0,this._err="",this._data={},this._close=()=>this.dispatchEvent(new CustomEvent("popover-close")),this._delete=()=>this.dispatchEvent(new CustomEvent("segment-delete",{detail:this.segment.id}))}willUpdate(t){t.has("segment")&&(this._si=this.segment.state,this._start=xt(this.segment.start),this._end=xt(this.segment.end),this._jit=this.segment.jitter??0,this._data={...this.segment.data??{}},this._err=""),this._seedSelects()}_seedSelects(){for(const t of this._params){if("select"!==t.kind)continue;const e=this._data[t.key];if(void 0!==e&&""!==e)continue;const i=Ct(this.hass,this.entities,t);i.length&&(this._data={...this._data,[t.key]:i[0].value})}}get _params(){return kt(this.types,this.type,this._si)?zt(this.types,this.type):[]}_setParam(t,e){this._data={...this._data,[t]:e}}_paramNumber(t){const e=jt(this.types,this.type,this._si,{data:this._data},t);return"number"==typeof e?e:Number(e??t.default??0)}_step(t,e){const i=t.step??1;let s=this._paramNumber(t)+e*i;void 0!==t.min&&(s=Math.max(t.min,s)),void 0!==t.max&&(s=Math.min(t.max,s)),s=Math.round(s/i)*i,this._setParam(t.key,Math.round(1e4*s)/1e4)}_save(){const t=wt(this._start),e=wt(this._end);if(null==t||null==e)return this._fail("Use HH:MM");if(e<=t)return this._fail("End must be after start");if(t<this.bounds.min||e>this.bounds.max)return this._fail(`Stay within ${xt(this.bounds.min)}–${xt(this.bounds.max)}`);const i=new Set;for(const t of this._params)for(const e of Pt(t))i.add(e);const s={};for(const t of i)void 0!==this._data[t]&&(s[t]=this._data[t]);this.dispatchEvent(new CustomEvent("segment-save",{detail:{...this.segment,state:this._si,start:t,end:e,jitter:this._jit,data:s}}))}_fail(t){this._err=t}render(){const t=this.types[this.type]?.states??[];return W`
    ...
    `}_renderParam(t){return"select"===t.kind?this._renderSelect(t):"slider"===t.kind?this._renderSlider(t):"media"===t.kind?this._renderMedia(t):this._renderStepper(t)}_renderSelect(t){const e=Ct(this.hass,this.entities,t);if(!e.length)return t.optional?q:W`
      ...
      `;const i=String(jt(this.types,this.type,this._si,{data:this._data},t)??"");return W`
      <div class="field-label" style="margin-top:12px">${t.label}</div>
      <div class="state-buttons" style=${`--accent:${this.accent}`}>
        ${e.map(e=>W`
            <button
    ...
    `}_renderMedia(t){const e={media_content_id:this._data.media_content_id,media_content_type:this._data.media_content_type};return W`
      ...
      ></ha-selector>
    `}_onMedia(t){this._data={...this._data,media_content_id:t?.media_content_id,media_content_type:t?.media_content_type??"music",media_title:t?.metadata?.title}}};It.styles=[Rt,a`
      .row {
        display: flex;
        gap: 10px;
        margin: 14px 0 6px;
    ...
    `],t([pt({attribute:!1})],It.prototype,"hass",void 0),t([pt({attribute:!1})],It.prototype,"segment",void 0),t([pt()],It.prototype,"type",void 0),t([pt({attribute:!1})],It.prototype,"types",void 0),t([pt({attribute:!1})],It.prototype,"bounds",void 0),t([pt({attribute:!1})],It.prototype,"accent",void 0),t([pt({attribute:!1})],It.prototype,"entities",void 0),t([ut()],It.prototype,"_si",void 0),t([ut()],It.prototype,"_start",void 0),t([ut()],It.prototype,"_end",void 0),t([ut()],It.prototype,"_jit",void 0),t([ut()],It.prototype,"_err",void 0),t([ut()],It.prototype,"_data",void 0),It=t([ct("ds-segment-editor")],It);let Wt=class extends ot{constructor(){super(...arguments),this.accent=""}render(){const t=this.types[this.bar.type]?.states??[];return W`
  ...
  `,t([pt({attribute:!1})],Xt.prototype,"hass",void 0),t([ut()],Xt.prototype,"_config",void 0),t([ut()],Xt.prototype,"_entries",void 0),Xt=t([ct("ds-editor")],Xt);const qt=()=>{const t=new Date;return t.getHours()+t.getMinutes()/60+t.getSeconds()/3600};let Kt=class extends ot{constructor(){super(...arguments),this._types={},this._now=qt(),this._syncing=!1,this._menuOpen=!1,this._connecting=!1,this._onBarChange=(t,e)=>{this._schedule&&(this._schedule={...this._schedule,bars:this._schedule.bars.map(e=>e.id===t.id?t:e)},e&&this._ws("update_bar",{bar_id:t.id,bar:t}))}}static getConfigElement(){return document.createElement("ds-editor")}static getStubConfig(){return{entry_id:""}}setConfig(t){this._config=t,this._entryId=t.entry_id||void 0,this._connectedEntry&&this._connectedEntry!==this._entryId&&this._teardown()}connectedCallback(){super.connectedCallback(),this._nowTimer=window.setInterval(()=>this._now=qt(),3e4),this._maybeConnect()}disconnectedCallback(){super.disconnectedCallback(),this._nowTimer&&window.clearInterval(this._nowTimer),this._teardown()}updated(){this._maybeConnect()}async _maybeConnect(){if(this.hass&&!this._connectedEntry&&!this._connecting){this._connecting=!0;try{await this._connect()}finally{this._connecting=!1}}}async _connect(){if(!this._entryId)try{const t=await this.hass.callWS({type:`${bt}/list_entries`});if(this._types=t.types,1!==t.entries.length)return 0===t.entries.length?void(this._error="No Daily Schedule is set up. Add the integration first."):void(this._error="Multiple schedules found — set entry_id in the card config.");this._entryId=t.entries[0].entry_id}catch(t){return void(this._error=`Could not reach Daily Schedule: ${t}`)}this._connectedEntry=this._entryId,this._error=void 0;try{this._unsub=this.hass.connection.subscribeMessage(t=>{this._schedule=t},{type:`${bt}/subscribe`,entry_id:this._entryId});const t=await this.hass.callWS({type:`${bt}/get`,entry_id:this._entryId});this._types=t.types,this._schedule=t}catch(t){this._error=`Could not load schedule: ${t}`,this._connectedEntry=void 0}}_teardown(){this._unsub?.then(t=>t()).catch(()=>{}),this._unsub=void 0,this._connectedEntry=void 0,this._schedule=void 0}async _ws(t,e={}){try{await this.hass.callWS({type:`${bt}/${t}`,entry_id:this._entryId,...e})}catch(e){this._error=`${t} failed: ${e}`}}_setEnabled(t){this._schedule&&(this._schedule={...this._schedule,enabled:t}),this._ws("set_enabled",{enabled:t})}async _syncNow(){this._schedule?.enabled&&(this._syncing=!0,await this._ws("sync_now"),window.setTimeout(()=>this._syncing=!1,1400))}_addBar(t){this._menuOpen=!1;const e=this._types[t];if("stateless"===e?.kind){const i=e.actions?.[0];return void this._ws("add_bar",{bar:{name:"New triggers",type:t,targets:[],enabled:!0,triggers:[{at:12,jitter:0,action:{service:i?.service,entity_id:""}}]}})}this._ws("add_bar",{bar:{name:"New schedule",type:t,targets:[],base:0,enabled:!0,segments:[{start:8,end:18,state:1,jitter:0}]}})}render(){if(this._error)return this._card(W`<div class="error">${this._error}</div>`);if(!this._schedule)return this._card(W`<div class="loading">Loading…</div>`);const t=this._schedule,e=t.bars.length,i=this._config?.title??"Daily Schedule";return this._card(W`
    ...
    `)}_card(t){return W`<ha-card>${t}</ha-card>`}getCardSize(){return 3+(this._schedule?.bars.length??1)}};Kt.styles=[Rt,a`
    ha-card {
      overflow: visible;
    }
    .error,
