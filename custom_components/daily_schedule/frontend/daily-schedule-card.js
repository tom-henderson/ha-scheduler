...
`;let Pt=class extends ot{constructor(){super(...arguments),this._name="",this._targets=[],this._save=()=>{this.dispatchEvent(new CustomEvent("bar-settings-save",{detail:{name:this._name.trim()||this.bar.name,targets:this._targets}}))}}willUpdate(t){t.has("bar")&&(this._name=this.bar.name,this._targets=[...this.bar.targets])}render(){const t={entity:{multiple:!0,filter:{domain:ft[this.bar.type]??[]}}};return W`
    ...
    `],t([pt({attribute:!1})],Pt.prototype,"hass",void 0),t([pt({attribute:!1})],Pt.prototype,"bar",void 0),t([ut()],Pt.prototype,"_name",void 0),t([ut()],Pt.prototype,"_targets",void 0),Pt=t([lt("ds-bar-settings")],Pt);let Mt=class extends ot{constructor(){super(...arguments),this.scheduleOn=!0,this.conflicts=[],this.now=0,this.syncing=!1,this._editing=null,this._drag=null,this._moved=!1,this._addSegment=()=>{const t=function(t){const e=t.segments.map(t=>[t.start,t.end]).sort((t,e)=>t[0]-e[0]);let i=null,s=0;const n=t=>t?t[1]-t[0]:0;for(const[t,r]of e)t-s>n(i)&&(i=[s,t]),s=Math.max(s,r);if(bt-s>n(i)&&(i=[s,bt]),!i||n(i)<.5)return null;const r=i[0];return{start:r,end:Math.min(i[1],r+Math.max(1,n(i)/2))}}(this.bar);if(!t)return;const e=0===this.bar.base?1:0,i={id:`seg_${Math.random().toString(36).slice(2,10)}`,start:t.start,end:t.end,state:e,jitter:0};this._emit({...this.bar,segments:[...this.bar.segments,i]},!0),this._editing=i.id},this._saveSegment=t=>{const e=t.detail;this._emit({...this.bar,segments:this.bar.segments.map(t=>t.id===e.id?e:t)},!0),this._editing=null},this._deleteSegment=t=>{this._emit({...this.bar,segments:this.bar.segments.filter(e=>e.id!==t.detail)},!0),this._editing=null},this._pickBase=t=>{this._emit({...this.bar,base:t.detail},!0),this._editing=null},this._saveSettings=t=>{this._emit({...this.bar,name:t.detail.name,targets:t.detail.targets},!0),this._editing=null}}get _live(){return this.scheduleOn&&this.bar.enabled}_emit(t,e){this.dispatchEvent(new CustomEvent("bar-change",{detail:{bar:t,commit:e}}))}_dragSeg(t,e,i){i.stopPropagation(),this._moved=!1;const s=Ct(this.bar,t),n=i.clientX,r=t.start,a=t.end;this._drag={id:t.id,mode:e};const o=this.renderRoot.querySelector(".track"),d=i=>{const d=o.getBoundingClientRect().width,l=Math.round((i.clientX-n)/d*bt/vt)*vt;Math.abs(i.clientX-n)>3&&(this._moved=!0);let c={...t};if("move"===e){const e=a-r,i=Math.min(s.max-e,Math.max(s.min,r+l));c={...t,start:i,end:i+e}}else c="l"===e?{...t,start:Math.min(a-vt,Math.max(s.min,r+l))}:{...t,end:Math.max(r+vt,Math.min(s.max,a+l))};this._emit({...this.bar,segments:this.bar.segments.map(e=>e.id===t.id?c:e)},!1)},l=()=>{window.removeEventListener("pointermove",d),window.removeEventListener("pointerup",l),this._drag=null,this._moved&&this._emit(this.bar,!0)};window.addEventListener("pointermove",d),window.addEventListener("pointerup",l)}render(){const t=yt(this.bar.type),e=this.types[this.bar.type],i=kt(this.bar),s=wt(this.types,this.bar.type,this.bar.base),n=i.find(t=>t.id===this._editing),r=(a=this.bar,o=this.now,kt(a).find(t=>o>=t.start&&o<t.end));var a,o;return W`
      <div class="bar" style=${`opacity:${this._live?1:.4};--accent:${t}`}>
        ...
        <div class="track" @click=${()=>this._editing="__base__"}>
          ...
          <div class="now" style=${`left:${this.now/bt*100}%`}></div>

          ${this.syncing&&this._live&&r?W`<div
                class="flash"
                style=${`left:${r.start/bt*100}%;width:${(r.end-r.start)/bt*100}%`}
              ></div>`:V}
          ${this.syncing&&this._live&&!r?W`<div class="flash base-flash"></div>`:V}
        </div>
    ...
    `}_renderSegment(t){const e=wt(this.types,this.bar.type,t.state),i=t.start/bt*100,s=(t.end-t.start)/bt*100,n=At(this.types,this.bar.type,t.state),r=e?(a=this.types,o=this.bar.type,d=t,Et(a,o).map(t=>{const e=St(a,o,d.state,d,t);return null==e||""===e?"":"number"===t.kind?`${e}${t.unit??""}`:String(e)}).filter(Boolean).join(" · ")):"";var a,o,d;const l=e?function(t,e,i){return t[e]?.states[i]?.color??yt(e)}(this.types,this.bar.type,t.state):"",c=this._drag?.id===t.id,h=c&&("move"===this._drag.mode||"l"===this._drag.mode),p=c&&("move"===this._drag.mode||"r"===this._drag.mode),u=`${$t(t.start)}–${$t(t.end)} · ${n}${r?` ${r}`:""}${t.jitter?` · ${function(t){return(mt.find(e=>Math.abs(e.v-t)<.001)??mt[0]).label}(t.jitter)}`:""}`;return W`
      <div
      ...
      >
        ...
        ${s>8?W`<span class="seg-label"
              >${n}${r?W`<span class="seg-sub">${r}</span>`:V}${t.jitter?W`<ha-icon icon="mdi:dice-5" style="--mdc-icon-size:12px"></ha-icon>`:V}</span
            >`:V}
  ...
  `],t([pt({attribute:!1})],Mt.prototype,"hass",void 0),t([pt({attribute:!1})],Mt.prototype,"bar",void 0),t([pt({attribute:!1})],Mt.prototype,"types",void 0),t([pt({type:Boolean})],Mt.prototype,"scheduleOn",void 0),t([pt({attribute:!1})],Mt.prototype,"conflicts",void 0),t([pt({type:Number})],Mt.prototype,"now",void 0),t([pt({type:Boolean})],Mt.prototype,"syncing",void 0),t([ut()],Mt.prototype,"_editing",void 0),t([ut()],Mt.prototype,"_drag",void 0),Mt=t([lt("ds-bar")],Mt);let Ot=class extends ot{constructor(){super(...arguments),this.accent="",this._si=0,this._start="",this._end="",this._jit=0,this._err="",this._data={},this._close=()=>this.dispatchEvent(new CustomEvent("popover-close")),this._delete=()=>this.dispatchEvent(new CustomEvent("segment-delete",{detail:this.segment.id}))}willUpdate(t){t.has("segment")&&(this._si=this.segment.state,this._start=$t(this.segment.start),this._end=$t(this.segment.end),this._jit=this.segment.jitter??0,this._data={...this.segment.data??{}},this._err="")}get _params(){return wt(this.types,this.type,this._si)?Et(this.types,this.type):[]}_setParam(t,e){this._data={...this._data,[t]:e}}_paramNumber(t){const e=St(this.types,this.type,this._si,{data:this._data},t);return"number"==typeof e?e:Number(e??t.default??0)}_step(t,e){const i=t.step??1;let s=this._paramNumber(t)+e*i;void 0!==t.min&&(s=Math.max(t.min,s)),void 0!==t.max&&(s=Math.min(t.max,s)),s=Math.round(s/i)*i,this._setParam(t.key,Math.round(1e4*s)/1e4)}_save(){const t=xt(this._start),e=xt(this._end);if(null==t||null==e)return this._fail("Use HH:MM");if(e<=t)return this._fail("End must be after start");if(t<this.bounds.min||e>this.bounds.max)return this._fail(`Stay within ${$t(this.bounds.min)}–${$t(this.bounds.max)}`);const i=new Set(this._params.map(t=>t.key)),s={};for(const t of i)void 0!==this._data[t]&&(s[t]=this._data[t]);this.dispatchEvent(new CustomEvent("segment-save",{detail:{...this.segment,state:this._si,start:t,end:e,jitter:this._jit,data:s}}))}_fail(t){this._err=t}render(){const t=this.types[this.type]?.states??[];return W`
    ...
    `}_renderParam(t){if("select"===t.kind){const e=String(St(this.types,this.type,this._si,{data:this._data},t)??"");return W`
      ...
      `}const e=this._paramNumber(t),i=(t.step??1)<1?1:0;return W`
      <div class="field-label" style="margin-top:12px">${t.label}</div>
    ...
    `],t([pt({attribute:!1})],Ot.prototype,"segment",void 0),t([pt()],Ot.prototype,"type",void 0),t([pt({attribute:!1})],Ot.prototype,"types",void 0),t([pt({attribute:!1})],Ot.prototype,"bounds",void 0),t([pt({attribute:!1})],Ot.prototype,"accent",void 0),t([ut()],Ot.prototype,"_si",void 0),t([ut()],Ot.prototype,"_start",void 0),t([ut()],Ot.prototype,"_end",void 0),t([ut()],Ot.prototype,"_jit",void 0),t([ut()],Ot.prototype,"_err",void 0),t([ut()],Ot.prototype,"_data",void 0),Ot=t([lt("ds-segment-editor")],Ot);let jt=class extends ot{constructor(){super(...arguments),this.accent=""}render(){const t=this.types[this.bar.type]?.states??[];return W`
    ...
    `}};jt.styles=[zt],t([pt({attribute:!1})],jt.prototype,"bar",void 0),t([pt({attribute:!1})],jt.prototype,"types",void 0),t([pt()],jt.prototype,"accent",void 0),jt=t([lt("ds-base-popover")],jt);let Ut=class extends ot{constructor(){super(...arguments),this._config={type:"custom:daily-schedule-card"},this._entries=[]}setConfig(t){this._config=t}async firstUpdated(){try{const t=await this.hass.callWS({type:`${gt}/list_entries`});this._entries=t.entries}catch{this._entries=[]}}_emit(t){const e={...this._config,...t};this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}render(){return W`
      <div class="form">
        <ha-select
          label="Schedule"
  ...
  `,t([pt({attribute:!1})],Ut.prototype,"hass",void 0),t([ut()],Ut.prototype,"_config",void 0),t([ut()],Ut.prototype,"_entries",void 0),Ut=t([lt("ds-editor")],Ut);const Nt=()=>{const t=new Date;return t.getHours()+t.getMinutes()/60+t.getSeconds()/3600};let Tt=class extends ot{constructor(){super(...arguments),this._types={},this._now=Nt(),this._syncing=!1,this._menuOpen=!1,this._connecting=!1,this._onBarChange=(t,e)=>{this._schedule&&(this._schedule={...this._schedule,bars:this._schedule.bars.map(e=>e.id===t.id?t:e)},e&&this._ws("update_bar",{bar_id:t.id,bar:t}))}}static getConfigElement(){return document.createElement("ds-editor")}static getStubConfig(){return{entry_id:""}}setConfig(t){this._config=t,this._entryId=t.entry_id||void 0,this._connectedEntry&&this._connectedEntry!==this._entryId&&this._teardown()}connectedCallback(){super.connectedCallback(),this._nowTimer=window.setInterval(()=>this._now=Nt(),3e4),this._maybeConnect()}disconnectedCallback(){super.disconnectedCallback(),this._nowTimer&&window.clearInterval(this._nowTimer),this._teardown()}updated(){this._maybeConnect()}async _maybeConnect(){if(this.hass&&!this._connectedEntry&&!this._connecting){this._connecting=!0;try{await this._connect()}finally{this._connecting=!1}}}async _connect(){if(!this._entryId)try{const t=await this.hass.callWS({type:`${gt}/list_entries`});if(this._types=t.types,1!==t.entries.length)return 0===t.entries.length?void(this._error="No Daily Schedule is set up. Add the integration first."):void(this._error="Multiple schedules found — set entry_id in the card config.");this._entryId=t.entries[0].entry_id}catch(t){return void(this._error=`Could not reach Daily Schedule: ${t}`)}this._connectedEntry=this._entryId,this._error=void 0;try{this._unsub=this.hass.connection.subscribeMessage(t=>{this._schedule=t},{type:`${gt}/subscribe`,entry_id:this._entryId});const t=await this.hass.callWS({type:`${gt}/get`,entry_id:this._entryId});this._types=t.types,this._schedule=t}catch(t){this._error=`Could not load schedule: ${t}`,this._connectedEntry=void 0}}_teardown(){this._unsub?.then(t=>t()).catch(()=>{}),this._unsub=void 0,this._connectedEntry=void 0,this._schedule=void 0}async _ws(t,e={}){try{await this.hass.callWS({type:`${gt}/${t}`,entry_id:this._entryId,...e})}catch(e){this._error=`${t} failed: ${e}`}}_setEnabled(t){this._schedule&&(this._schedule={...this._schedule,enabled:t}),this._ws("set_enabled",{enabled:t})}async _syncNow(){this._schedule?.enabled&&(this._syncing=!0,await this._ws("sync_now"),window.setTimeout(()=>this._syncing=!1,1400))}_addBar(t){this._menuOpen=!1,this._ws("add_bar",{bar:{name:"New schedule",type:t,targets:[],base:0,enabled:!0,segments:[{start:8,end:18,state:1,jitter:0}]}})}render(){if(this._error)return this._card(W`<div class="error">${this._error}</div>`);if(!this._schedule)return this._card(W`<div class="loading">Loading…</div>`);const t=this._schedule,e=t.bars.length,i=this._config?.title??"Daily Schedule";return this._card(W`
      <div class="header">
        <div>
      ...
      <div class="body">
        <div class="ruler">
          ${[0,6,12,18,24].map(t=>W`<span
              class="tick"
              style=${`left:${t/bt*100}%;transform:${0===t?"none":24===t?"translateX(-100%)":"translateX(-50%)"}`}
              >${$t(t)}</span
            >`)}
          <span class="now-label" style=${`left:${this._now/bt*100}%`}>${$t(this._now)}</span>
        </div>

        <div class="bars">
          <div class="gridlines">
            ${[6,12,18].map(t=>W`<div class="gl" style=${`left:${t/bt*100}%`}></div>`)}
          </div>
          ${t.bars.map(e=>W`
              <ds-bar
                .hass=${this.hass}
    ...
    `)}_card(t){return W`<ha-card>${t}</ha-card>`}getCardSize(){return 3+(this._schedule?.bars.length??1)}};Tt.styles=[zt,a`
    ha-card {
      overflow: visible;
    }
    .error,
  ...
  `],t([pt({attribute:!1})],Tt.prototype,"hass",void 0),t([ut()],Tt.prototype,"_config",void 0),t([ut()],Tt.prototype,"_schedule",void 0),t([ut()],Tt.prototype,"_types",void 0),t([ut()],Tt.prototype,"_entryId",void 0),t([ut()],Tt.prototype,"_error",void 0),t([ut()],Tt.prototype,"_now",void 0),t([ut()],Tt.prototype,"_syncing",void 0),t([ut()],Tt.prototype,"_menuOpen",void 0),Tt=t([lt("daily-schedule-card")],Tt),window.customCards=window.customCards||[],window.customCards.push({type:"daily-schedule-card",name:"Daily Schedule",description:"Build a repeating 24-hour schedule that drives your entities.",preview:!1});export{Tt as DailyScheduleCard};
